var Chart = function (s) {
    ...
    window.devicePixelRatio &&
        ((s.canvas.style.width = q + "px"), (s.canvas.style.height = u + "px"), (s.canvas.height = u * window.devicePixelRatio), (s.canvas.width = q * window.devicePixelRatio), s.scale(window.devicePixelRatio, window.devicePixelRatio));
